...
public class SlagalicaGamePositiveTestCase extends SlagalicaBaseTest{
    @Test(priority = 4)
    ...
    @Test(priority = 5)
    public void clickCorrectLettersTest() {
        this.slagalicaPage.clickLettersMatchingComputerWord();
    }
