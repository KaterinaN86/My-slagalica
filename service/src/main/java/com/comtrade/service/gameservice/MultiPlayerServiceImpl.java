...
public class MultiPlayerServiceImpl implements MultiPlayerService {
    ...
    private List<Principal> playerQueue = new ArrayList<>();
    ...
    public void createTwoPlayerGame(Principal principal) {
        if (playerQueue.size() >= 2) {
            Principal user1 = playerQueue.get(0);
            Principal user2 = playerQueue.get(1);
            ...
            TwoPlayerGame twoPlayerGame = new TwoPlayerGame(isActive1, isActive2, (User) user1, (User) user2, games, timers1, timers2);
