...
public class SpojniceServiceImpl implements SpojniceService{
    ...
    public SpojniceServiceImpl(SpojniceRepository spojniceRepository, PairsRepository pairsRepository, OnePlayerGameRepository onePlayerGameRepository,TwoPlayerGameRepository twoPlayerGameRepository, OnePlayerOnePlayerGameServiceImpl gameService) {
